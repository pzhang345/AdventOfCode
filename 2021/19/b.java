...
class b{
    ...
    public static void main(String[] args){
        ...
        for(Scanner i: scanners){
            for(Scanner j: scanners){
                if(max < Math.abs(i.scannerPos[0] - j.scannerPos[0]) + Math.abs(i.scannerPos[1] - j.scannerPos[1]) + Math.abs(i.scannerPos[2] - j.scannerPos[2])){
                    max = Math.abs(i.scannerPos[0] - j.scannerPos[0]) + Math.abs(i.scannerPos[1] - j.scannerPos[1]) + Math.abs(i.scannerPos[2] - j.scannerPos[2]);
                }
            }
        }
